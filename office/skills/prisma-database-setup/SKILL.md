...
description: "Read when setting up or troubleshooting Prisma ORM — initializing a project, choosing or switching a database provider (PostgreSQL, MySQL, SQLite, MongoDB, SQL Server, CockroachDB, Prisma Postgres), configuring connection strings and driver adapters, or generating and instantiating Prisma Client."
---

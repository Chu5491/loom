...
description: "Read when writing, reviewing, or refactoring NestJS code — building modules/controllers/services, implementing auth, optimizing performance or database queries, or designing microservices — to apply the prioritized best-practice rules."
---
...
For the complete guide with all rules expanded, read `AGENTS.md`.

...
description: "Read when writing or improving project documentation: READMEs, architecture and data-flow docs, API references, or explanatory code comments, especially to onboard new developers. Ships templates and a step-by-step documentation workflow."
---
# Codebase Documenter

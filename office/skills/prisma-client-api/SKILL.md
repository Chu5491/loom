...
description: "Read when writing or debugging database queries with Prisma Client — CRUD operations, filtering, sorting, relations, nested writes, transactions, raw SQL, or PrismaClient setup/configuration."
---

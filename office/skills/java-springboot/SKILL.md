...
description: "Read when writing, reviewing, or structuring a Spring Boot (Java) application — covers project layout, dependency injection, configuration, REST controllers, service/data layers, logging, testing, and security best practices."
---

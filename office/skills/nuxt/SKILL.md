---
name: nuxt
description: "Read when working in a Nuxt 3 (Vue full-stack) project — questions about file-based routing, data fetching (useFetch/useAsyncData), SSR/hydration, auto-imports, state, server/API routes, modules, layers, rendering modes, or deployment with Nitro."
---
Nuxt is a full-stack Vue framework that provides server-side rendering, file-based routing, auto-imports, and a powerful module system. It uses Nitro as its server engine for universal deployment across Node.js, serverless, and edge platforms.

> This skill is based on Nuxt 3.x, generated 2026-01-28.

Each topic below links to a detailed reference file. Read the relevant reference on demand when working on that area.

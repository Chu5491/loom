---
name: readme-i18n
description: "Read when the user wants to localize or translate a repository README into one or more other languages — creating localized sibling files like README.zh.md, preserving GitHub-flavored Markdown structure, code, badges, and anchor links, and wiring up a shared language selector across every variant."
---

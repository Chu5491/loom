...
Before doing anything, get the project config and installed components by running:

```bash
npx shadcn@latest info --json
```

The JSON it prints contains the project config and installed components (see [Key Fields](#key-fields) below). Use `npx shadcn@latest docs <component>` to get documentation and example URLs for any component.
...
1. **Get project context** — run `npx shadcn@latest info` (see [Current Project Context](#current-project-context) above). Re-run it whenever you need to refresh.

...
description: "Read when writing or reviewing Alembic migrations or SQLAlchemy models — adding indexes, constraints, foreign keys, or changing column types — to ensure production-safe, lock-free schema changes."
---
